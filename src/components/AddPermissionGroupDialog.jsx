...
const copy = {
  ar: {
    title: 'إضافة جديد',
    subtitle: 'إضافة مجموعة صلاحيات جديدة',
  ...
  en: {
    title: 'Add new',
    subtitle: 'Add a new permission group',
...
export default function AddPermissionGroupDialog({ open, onOpenChange, onSave, isArabic }) {
        ...
        <form onSubmit={handleSubmit} className="px-5 pb-5 pt-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="permission-group-name-ar" className="text-sm font-medium text-gray-800">
                {t.nameArLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="permission-group-name-ar"
                type="text"
                value={nameAr}
                onChange={(e) => {
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="permission-group-name-en" className="text-sm font-medium text-gray-800">
                {t.nameEnLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="permission-group-name-en"
                type="text"
                value={nameEn}
                onChange={(e) => {
