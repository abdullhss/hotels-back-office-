...
export default function AddCountryDialog({ open, onOpenChange, onSave, isArabic }) {
        ...
        <form onSubmit={handleSubmit} className="px-5 pb-5 pt-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="country-name-ar" className="text-sm font-medium text-gray-800">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="country-name-en" className="text-sm font-medium text-gray-800">
