...
const copy = {
  ar: {
    title: 'إضافة ميزة',
    subtitle: 'إضافة ميزة أو خاصية للفندق',
...
export default function AddHotelFeatureDialog({ open, onOpenChange, onSave, isArabic }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSave({ nameAr: ar, nameEn: en.trim() })
    onOpenChange(false)
  }
        ...
        <form onSubmit={handleSubmit} className="px-5 pb-5 pt-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="hotel-feature-name-ar" className="text-sm font-medium text-gray-800">
                {t.nameArLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="hotel-feature-name-ar"
                type="text"
                value={nameAr}
                onChange={(e) => {
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="hotel-feature-name-en" className="text-sm font-medium text-gray-800">
                {t.nameEnLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="hotel-feature-name-en"
                type="text"
                value={nameEn}
                onChange={(e) => {
