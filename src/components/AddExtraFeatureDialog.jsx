...
const copy = {
  ar: {
    title: 'إضافة جديد',
    subtitle: 'إضافة خاصية إضافية جديدة',
  ...
  en: {
    title: 'Add new',
    subtitle: 'Add a new additional feature',
...
export default function AddExtraFeatureDialog({ open, onOpenChange, onSave, isArabic }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSave({ nameAr: ar, nameEn: en.toUpperCase(), basicPrice: parsed })
    onOpenChange(false)
  }
        ...
        <form onSubmit={handleSubmit} className="px-5 pb-5 pt-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="extra-feature-name-ar" className="text-sm font-medium text-gray-800">
                {t.nameArLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="extra-feature-name-ar"
                type="text"
                value={nameAr}
                onChange={(e) => {
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="extra-feature-name-en" className="text-sm font-medium text-gray-800">
                {t.nameEnLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="extra-feature-name-en"
                type="text"
                value={nameEn}
                onChange={(e) => {
            ...
            <div className="flex flex-col gap-1.5 sm:col-span-2">
              <label htmlFor="extra-feature-price" className="text-sm font-medium text-gray-800">
                {t.priceLabel} <span className="text-red-600">*</span>
              </label>
              <input
                id="extra-feature-price"
                type="text"
                inputMode="decimal"
                value={priceInput}
                onChange={(e) => {
